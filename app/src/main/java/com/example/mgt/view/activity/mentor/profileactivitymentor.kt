...
import com.example.mgt.databinding.ActivityProfileactivitymentorBinding
import com.example.mgt.databinding.CustomDialogItemBinding
import com.example.mgt.view.fragment.mentor.path
import com.example.mgt.view.fragment.mentor.uri
...
class profileactivitymentor : AppCompatActivity() {
    private lateinit var profileactivitymentorBinding: ActivityProfileactivitymentorBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        profileactivitymentorBinding = ActivityProfileactivitymentorBinding.inflate(layoutInflater)
        setContentView(profileactivitymentorBinding.root)
        ...
        profileactivitymentorBinding.mentorprofilename.text = name
        profileactivitymentorBinding.mentorprofileEmail.text = email
        profileactivitymentorBinding.MentorProfileOhone.text = phone
        profileactivitymentorBinding.MentorProfileSubject.text = subject
       profileactivitymentorBinding.MentorprofileExam.text = Exam
        ...
        profileactivitymentorBinding.editimage.setOnClickListener {
            showcustompicDialog()
        }
    }
        ...
        customDialogItemBinding.gallerytv.setOnClickListener {
            ...
            withPermission(
                ...
                override fun onPermissionDenied(p0: PermissionDeniedResponse?) {
                    Toast.makeText(this@profileactivitymentor,
            ...
            if(requestCode==1){
                data?.extras?.let {
                    ...
                    Glide.with(this)
                        ...
                        .into(profileactivitymentorBinding.profileImage)
 ...
 private fun uploadfile(imagepath :File){
    ...
    retrofit.uplaodimage("Bearer $token",body)
